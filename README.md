[![Build](https://github.com/VoltixTeam/Voltix_MSP430Fram/actions/workflows/build.yml/badge.svg)](https://github.com/VoltixTeam/Voltix_MSP430Fram/actions/workflows/build.yml)
...
You can also download the latest binary build [here](https://github.com/VoltixTeam/Voltix_MSP430Fram/releases/latest).

## Flashing

To flash the firmware on the MSP430FR5962 on the Voltix module/board, install the [voltix-probe tool](https://github.com/VoltixTeam/Voltix_ProbeSoftware?tab=readme-ov-file#installing-the-command-line-tool) with:
...
```bash
voltix-probe program -d msp430 -f PATH_TO/firmware.hex
```
